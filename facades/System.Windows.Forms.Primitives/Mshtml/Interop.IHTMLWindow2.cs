...
public partial class Interop
{
    public partial class Mshtml
    {
        ...
        {
            [return: CustomMarshalAs(UnmanagedType.IDispatch)] object Item([In] ref object pvarIndex);
            int GetLength();
            [return: CustomMarshalAs(UnmanagedType.Interface)] IHTMLFramesCollection2 GetFrames();
            ...
            [return: CustomMarshalAs(UnmanagedType.Struct)] object Prompt([In] string message, [In] string defstr);
            object GetImage();
            [return: CustomMarshalAs(UnmanagedType.Interface)] IHTMLLocation GetLocation();
            [return: CustomMarshalAs(UnmanagedType.Interface)] IOmHistory GetHistory();
            void Close();
            void SetOpener([In] object p);
            [return: CustomMarshalAs(UnmanagedType.IDispatch)] object GetOpener();
            [return: CustomMarshalAs(UnmanagedType.Interface)] IOmNavigator GetNavigator();
            void SetName([In] string p);
            string GetName();
            [return: CustomMarshalAs(UnmanagedType.Interface)] IHTMLWindow2 GetParent();
            [return: CustomMarshalAs(UnmanagedType.Interface)] IHTMLWindow2 Open([In] string URL, [In] string name, [In] string features, [In] bool replace);
            object GetSelf();
            object GetTop();
            object GetWindow();
            ...
            object GetOnscroll();
            [return: CustomMarshalAs(UnmanagedType.Interface)] IHTMLDocument2 GetDocument();
            [return: CustomMarshalAs(UnmanagedType.Interface)] IHTMLEventObj GetEvent();
            object Get_newEnum();
            ...
            [return: CustomMarshalAs(UnmanagedType.Interface)] IHTMLScreen GetScreen();
            object GetOption();
            void Focus();
            bool GetClosed();
            void Blur();
            ...
            [return: CustomMarshalAs(UnmanagedType.Struct)] object ExecScript([In] string code, [In] string language);
            string toString();
