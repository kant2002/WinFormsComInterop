...
public partial class Interop
{
    public partial class Mshtml
    {
        ...
        {
            [return: CustomMarshalAs(UnmanagedType.IDispatch)] object GetScript();
            ...
            [return: CustomMarshalAs(UnmanagedType.Interface)] object GetSelection();
            string GetReadyState();
            [return: CustomMarshalAs(UnmanagedType.Interface)] object GetFrames();
            ...
            string GetProtocol();
            string GetNameProp();
            int Write([In, CustomMarshalAs(UnmanagedType.SafeArray)] object[] psarray);
            int WriteLine([In, CustomMarshalAs(UnmanagedType.SafeArray)] object[] psarray);
            [return: CustomMarshalAs(UnmanagedType.Interface)] object Open(string mimeExtension, object name, object features, object replace);
            void Close();
            void Clear();
            ...
            [return: CustomMarshalAs(UnmanagedType.Interface)] IHTMLWindow2 GetParentWindow();
            [return: CustomMarshalAs(UnmanagedType.Interface)] object GetStyleSheets();
            void SetOnbeforeupdate(object p);
            object GetOnbeforeupdate();
            void SetOnerrorupdate(object p);
            object GetOnerrorupdate();
            string toString();
            [return: CustomMarshalAs(UnmanagedType.Interface)] object CreateStyleSheet(string bstrHref, int lIndex);
        }
    }
}
