...
public partial class Interop
{
    public partial class Mshtml
    {
        ...
        public interface IHTMLElement
        {
            ...
            int GetOffsetWidth();
            int GetOffsetHeight();
            [return: CustomMarshalAs(UnmanagedType.Interface)] IHTMLElement GetOffsetParent();
            ...
            bool GetIsTextEdit();
            void Click();
            [return: CustomMarshalAs(UnmanagedType.Interface)] object GetFilters();
            ...
            [return: CustomMarshalAs(UnmanagedType.IDispatch)] object GetChildren();
            [return: CustomMarshalAs(UnmanagedType.IDispatch)] object GetAll();
        }
    }
}
