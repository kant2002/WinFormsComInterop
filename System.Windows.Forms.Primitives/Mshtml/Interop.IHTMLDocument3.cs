...
public partial class Interop
{
    public partial class Mshtml
    {
        ...
        public interface IHTMLDocument3
        {
            ...
            [return: CustomMarshalAs(UnmanagedType.Interface)] IHTMLElement GetDocumentElement();
            string GetUniqueID();
            bool AttachEvent([In] string ev, [In, CustomMarshalAs(UnmanagedType.IDispatch)] object pdisp);
            void DetachEvent([In] string ev, [In, CustomMarshalAs(UnmanagedType.IDispatch)] object pdisp);
            ...
            string GetBaseUrl();
            [return: CustomMarshalAs(UnmanagedType.IDispatch)] object GetChildNodes();
            ...
            [return: CustomMarshalAs(UnmanagedType.Interface)] IHTMLElementCollection GetElementsByName([In] string v);
            [return: CustomMarshalAs(UnmanagedType.Interface)] IHTMLElement GetElementById([In] string v);
            [return: CustomMarshalAs(UnmanagedType.Interface)] IHTMLElementCollection GetElementsByTagName([In] string v);
        }
    }
}
