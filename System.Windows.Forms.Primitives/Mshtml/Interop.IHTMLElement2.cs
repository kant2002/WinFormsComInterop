...
public partial class Interop
{
    public partial class Mshtml
    {
        ...
        public interface IHTMLElement2
        {
            ...
            int ClientTop();
            int ClientLeft();
            bool AttachEvent(string ev, [In, CustomMarshalAs(UnmanagedType.IDispatch)] object pdisp);
            void DetachEvent(string ev, [In, CustomMarshalAs(UnmanagedType.IDispatch)] object pdisp);
            object ReadyState();
            ...
            [return: CustomMarshalAs(UnmanagedType.Interface)]
            IHTMLElement
                InsertAdjacentElement(string @where,
                    [In, CustomMarshalAs(UnmanagedType.Interface)] IHTMLElement insertedElement);
            [return: CustomMarshalAs(UnmanagedType.Interface)]
            IHTMLElement
                applyElement([In, CustomMarshalAs(UnmanagedType.Interface)] IHTMLElement apply,
                    string @where);
            ...
            [return: CustomMarshalAs(UnmanagedType.Interface)] IHTMLElementCollection GetElementsByTagName(string v);
        }
    }
}
