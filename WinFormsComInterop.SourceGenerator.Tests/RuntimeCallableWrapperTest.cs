    ...
    unsafe partial class C : global::Foo.IStr
    {
        object global::Foo.IStr.CopyTo()
        {
            ...
            try
            {
                ...
                return retVal == System.IntPtr.Zero ? null : Marshal.GetObjectForNativeVariant(retVal);
            }
            finally
            {
                Marshal.Release(thisPtr);
    ...
    unsafe partial class C : global::Foo.IStr
    {
        void global::Foo.IStr.CopyTo(out object param)
        {
            ...
            try
            {
                ...
                param = local_0 == System.IntPtr.Zero ? null : Marshal.GetObjectForNativeVariant(local_0);
            }
            finally
            {
                Marshal.Release(thisPtr);
    ...
    unsafe partial class C : global::Foo.IStr
    {
        void global::Foo.IStr.CopyTo(ref object param)
        {
            ...
            try
            {
                var comDispatch = (System.IntPtr*)thisPtr;
                var vtbl = (System.IntPtr*)comDispatch[0];
                WinFormsComInterop.InteropServices.Variant local_0_variant = new WinFormsComInterop.InteropServices.Variant();
                System.IntPtr local_0 = (System.IntPtr)(WinFormsComInterop.InteropServices.Variant*)&local_0_variant;
                Marshal.GetNativeVariantForObject(param, local_0);
                result = ((delegate* unmanaged<System.IntPtr, System.IntPtr*, int>)vtbl[3])(thisPtr, &local_0);
                if (result != 0)
                {
                    Marshal.ThrowExceptionForHR(result);
