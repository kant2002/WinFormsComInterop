    ...
    unsafe partial class C : global::Foo.IStr
    {
        void global::Foo.IStr.Stat(global::Foo.STATSTG[] pstatstg)
        {
            ...
            try
            {
                var comDispatch = (System.IntPtr*)thisPtr;
                var vtbl = (System.IntPtr*)comDispatch[0];
                ref global::Foo.STATSTG pstatstgRef = ref pstatstg == null ? ref *(global::Foo.STATSTG*)0 : ref System.Runtime.InteropServices.MemoryMarshal.GetArrayDataReference(pstatstg);
...
namespace Foo
{
    ...
    unsafe partial class C : global::Foo.IStr
    {
        ...
        [TestMethod]
        public void MethodAfterProperty()
        {
            string source = @"
namespace Foo
{
...
namespace Foo
{
    ...
    unsafe partial class C : global::Foo.IStr
    {
        int global::Foo.IStr.HelloCount
        {
            get
            {
                var targetInterface = new System.Guid(""22DD68D1-86FD-4332-8666-9ABEDEA2D24C"");
                ...
                try
                {
                    ...
                    var vtbl = (System.IntPtr*)comDispatch[0];
                    int retVal;
                    result = ((delegate* unmanaged<System.IntPtr, int*, int>)vtbl[3])(thisPtr, &retVal);
                    if (result != 0)
                    {
                        Marshal.ThrowExceptionForHR(result);
                    }
        ...
        void global::Foo.IStr.SayHello(string toWhom)
        {
            var targetInterface = new System.Guid(""22DD68D1-86FD-4332-8666-9ABEDEA2D24C"");
            var result = Marshal.QueryInterface(this.instance, ref targetInterface, out var thisPtr);
            if (result != 0)
            ...
            try
            {
                var comDispatch = (System.IntPtr*)thisPtr;
                var vtbl = (System.IntPtr*)comDispatch[0];
                var local_0 = Marshal.StringToCoTaskMemUni(toWhom);
                result = ((delegate* unmanaged<System.IntPtr, System.IntPtr, int>)vtbl[4])(thisPtr, local_0);
                if (result != 0)
                {
                    Marshal.ThrowExceptionForHR(result);
                }
...
namespace Foo
{
    ...
    public interface IStr
    {
        void Read(byte* @object, uint cb, uint* pcbRead);
    }
...
namespace Foo
{
    ...
    unsafe partial class C : global::Foo.IStr
    {
        void global::Foo.IStr.Read(byte* @object, uint cb, uint* pcbRead)
        {
            var targetInterface = new System.Guid(""22DD68D1-86FD-4332-8666-9ABEDEA2D24C"");
            var result = Marshal.QueryInterface(this.instance, ref targetInterface, out var thisPtr);
            if (result != 0)
            ...
            try
            {
                var comDispatch = (System.IntPtr*)thisPtr;
                var vtbl = (System.IntPtr*)comDispatch[0];
                result = ((delegate* unmanaged<System.IntPtr, byte*, uint, uint*, int>)vtbl[3])(thisPtr, @object, cb, pcbRead);
                if (result != 0)
                {
                    Marshal.ThrowExceptionForHR(result);
                }
